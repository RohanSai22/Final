...
import { type MindMapData, type MindMapNode, type MindMapEdge } from '@/services/autonomousResearchAgent';
...
const CustomNode = ({ data, selected }: { data: any; selected: boolean }) => {
  ...
  return (
    ...
    >
      ...
      <Badge variant="outline" className="mt-1 text-xs bg-white/10 border-white/30 text-white">
        Level {data.level}
      </Badge>
    </div>
  );
