        ...
        <CardHeader className="pb-4">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl text-gray-800">Research Report</CardTitle>
                <p className="text-sm text-gray-600 mt-1">
                  Autonomous research completed • {report.wordCount} words • {report.sources.length} sources
                </p>
              </div>
            </div>
                ...
                <div className="flex items-center gap-2 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {source.url !== "User uploaded documents" ? (
                      ...
                      <p className="text-sm text-gray-600 mt-1">User uploaded files</p>
                    )}
                  </div>
                </div>
