...
const ChatPage = () => {
  ...
  // Enhanced state for perfect mind map
  const [perfectMindMapData, setPerfectMindMapData] = useState<PerfectMindMapData | null>(null);
  const [usePerfectMindMap, setUsePerfectMindMap] = useState(true);
  ...
  const [fullMindMapData, setFullMindMapData] = useState<any>(null);
  const [displayedMindMapData, setDisplayedMindMapData] = useState<any>(null);
    ...
    if (location.state) {
      ...
      if (existingSessionId) {
        ...
        if (
          ...
          // Load advanced mind map data if available
          if (savedSession.advancedMindMapData) {
            setAdvancedMindMapData(savedSession.advancedMindMapData);
            console.log("ChatPage: Restored advanced mind map data");
          }

          // Legacy mind map data support
