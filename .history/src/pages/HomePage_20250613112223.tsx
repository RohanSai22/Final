...
const HomePage = () => {
  ...
  const [autonomousMode, setAutonomousMode] = useState(true); // Default to autonomous mode
  ...
  const handleSubmit = async () => {
    ...
    // Navigate to appropriate chat page based on mode
    const targetPage = autonomousMode ? "/autonomous" : "/chat";
    navigate(targetPage, {
      state: {
        query,
        files: uploadedFiles,
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-white font-medium">
                        {autonomousMode ? "Autonomous Agent" : "Guided Research"}
                      </span>
                      <span className="text-xs text-slate-400">
                        {autonomousMode
                          ? "AI-driven, single-click research"
