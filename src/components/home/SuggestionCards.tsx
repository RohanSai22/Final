  ...
  const suggestionCards = [
    {
      ...
      hoverGradient:
        "group-hover:from-emerald-400 group-hover:via-teal-400 group-hover:to-cyan-400",
    },
    {
      ...
      hoverGradient:
        "group-hover:from-amber-400 group-hover:via-orange-400 group-hover:to-red-400",
    },
    {
      ...
      hoverGradient:
        "group-hover:from-violet-400 group-hover:via-purple-400 group-hover:to-indigo-400",
    },
  ];
  ...
  return (
    <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
      {suggestionCards.map((card, index) => (
        ...
        >
          <div
            className={`absolute inset-0 bg-gradient-to-br ${card.gradient} opacity-5 ${card.hoverGradient} transition-all duration-500`}
          />

          <div className="relative p-6 text-white">
            <div
              className={`text-transparent bg-gradient-to-r ${card.gradient} bg-clip-text mb-4 group-hover:scale-110 transition-transform duration-300`}
            >
              {card.icon}
            </div>
